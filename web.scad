...
union() {
    ...
    translate([key_radius - (key_radius / 2), key_width + (key_radius / 2), 0]) rotate([0, 0, -45]) key_shape(7);
    color("Green") translate([0, key_width, 0]) rotate([0, 0, -45]) cube([50, 7, 7]);

    translate([key_height + (key_radius / 2), key_radius - (key_radius / 2), 0]) rotate([0, 0, 135]) key_shape(7);
    color("Blue") translate([key_height + key_radius, key_radius, 0]) rotate([0, 0, 135]) cube([50, 7, 7]);

    translate([key_height + (key_radius / 2), key_width + (key_radius / 2), 0]) rotate([0, 0, -135]) key_shape(7);
