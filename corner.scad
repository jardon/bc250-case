...
module corner_cube(type = "A") {
    difference() {
        ...
        rotate([0, 0, 0]) translate([28, 28, 7]) cylinder(h = 4, r = 2.3, $fn = 30);
        rotate([90, 90, 90]) translate([-28, 28, 7]) cylinder(h = 4, r = 2.3, $fn = 30);
        rotate([0, 90, 90]) translate([-28, -28, 7]) cylinder(h = 4, r = 2.3, $fn = 30);
    }
}
