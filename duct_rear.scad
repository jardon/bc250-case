...
difference() {
    ...
    translate([77, 28.5, 0]) cylinder(r = 2.3, h = 5, $fn = 100);
    translate([165, 28.5, 0]) cylinder(r = 2.3, h = 5, $fn = 100);
    ...
    translate([77, 27.5, height - 5]) cylinder(r = 2.3, h = 5, $fn = 100);
    translate([165, 27.5, height - 5]) cylinder(r = 2.3, h = 5, $fn = 100);
